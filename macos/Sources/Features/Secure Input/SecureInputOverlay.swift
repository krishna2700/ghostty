            ...
            HStack {
                ...
                Image(systemName: "lock.shield.fill")
                    ...
                    .popover(isPresented: $isPopover, arrowEdge: .bottom) {
                        ...
                        automatically whenever Blackbox Terminal detects a password prompt in the terminal,
                        or at all times if `Blackbox Terminal > Secure Keyboard Entry` is active.
                        """)
                        .padding(.all)
                    }
                    .padding(.top, 10)
