...
struct AboutView: View {
    ...
    private let githubURL = URL(string: "https://github.com/krishna2700/ghostty")
    private let docsURL = URL(string: "https://blackbox.ai/docs")

    /// Read the commit from the bundle.
    private var build: String? { Bundle.main.infoDictionary?["CFBundleVersion"] as? String }
    private var commit: String? { Bundle.main.infoDictionary?["BlackboxCommit"] as? String }
    ...
    private enum VersionConfig {
        ...
        var url: URL? {
            ...
            case .stable(let version):
                ...
                return URL(string: "https://blackbox.ai/docs/release-notes/\(slug)")
            default:
                return nil
            }
        }
