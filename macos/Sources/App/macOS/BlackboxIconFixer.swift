...
enum BlackboxIconFixer {
    ...
    private static func fixIcon() {
        ...
        // NOTE: Padding is already baked into Blackbox.icns at all sizes.
        // Do NOT apply additional padding here — it would double-pad and make the icon too small.
        ...
        for path in appsPaths where FileManager.default.fileExists(atPath: path) {
